        ...
        (function (Service) {
            var SudokuService = (function () {
                function SudokuService() {
                    var _this = this;
                    this.solveSUDOKU = function (data) {
                        var counterB = 0;
                        var C = new Array();
                        var FIX = new Array();
                        var RF = new Array();
                        var AvailableArray = new Array();
                        var referenceFrame = "111 112 113 124 125 126 137 138 139 " +
                        ...
                        for (var index = 0; index < 81; index++) {
                            ...
                            if (C[index] == 0) {
                                ...
                                resultX = _this.getAvailableForCell(index, RF[index], RF, C, AvailableArray, RealIndex, FIX);
                            }
                            if (resultX > 0) {
                    ...
                    this.solveSudokuNew = function (data, wSmall, hSmall, wBig, hBig) {
                        //var counterB = 0;
                        var C = new Array();
                        var FIX = new Array();
                        var RF = new Array();
                            ...
                            for (var wb = 1; wb <= wBig; wb++)
                                for (var hs = 0; hs < hSmall; hs++)
                                    for (var ws = 1; ws <= wSmall; ws++) {
                                        ...
                                        var referenceNode = new Sudoku.Models.ReferenceNode(row, col, block);
                    ...
                    this.getAvailableForCell = function (index, Reference, RF, C, AvailableArray, RealIndex, FIX) {
